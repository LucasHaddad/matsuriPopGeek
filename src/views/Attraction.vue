      ...
      <v-layout class="makeItWhite1">    
        ...
        <div class="margin1">
          <article>
            <h1>J-KAI</h1>
            <br/>
            <p>A banda J~Kai (J~界) foi idealizada por um grupo de amigos de Belo Horizonte (MG) a fim de difundir a música japonesa contemporânea e iniciou suas apresentações em 2008, com um repertório composto por diversos estilos musicais.
Durante o Matsuri Pop Geek, a banda vai estrear um novo formato com repertório acústico especialmente ensaiado para o evento.</p>
          </article>
        </div>
      </v-layout>
      <v-layout class="makeItWhite1">    
